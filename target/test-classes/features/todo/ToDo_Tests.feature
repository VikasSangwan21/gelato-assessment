Feature: To do list
  ...
  @ToDo @TC_008
  Scenario: The User should be able toggle all tasks using toggle all button
    When I enter "Task 1" to ToDo list
    Then I should see "Task 1" is added to ToDo list
    When I enter "Task 2" to ToDo list
    Then I should see "Task 2" is added to ToDo list
    ...
    Then I should see the status of all tasks changes to "completed"
    When I click on toggle all button
    Then I should see the status of all tasks changes to "to do"
